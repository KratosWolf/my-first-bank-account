...
| 2026-02-22 | Extra  | Task 2.15 — Cancelar e Realizar Sonhos (visão criança) implementada         | APIs criadas: /api/goals/add-money (depositar), /api/goals/cancel (cancelar + devolver saldo), /api/goals/resolve-fulfillment aprimorada (debitar saldo ao aprovar). Componentes GoalCard + DreamBoard com botões e handlers completos. Transações goal_deposit, goal_withdrawal, goal_purchase rastreadas. App compila. ✅ |
